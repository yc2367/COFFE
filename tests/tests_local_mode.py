...
# invoke COFFE with input file
subprocess.call('python coffe.py input_files/sram0.txt -i 4 -o local >testsram.log', shell=True, executable='/bin/bash') 
# Run the tests
...
# invoke COFFE with input file
subprocess.call('python coffe.py input_files/mtj0.txt -i 4 -o local >testmtj.log', shell=True, executable='/bin/bash') 
# Run the tests
...
# invoke COFFE with input file
subprocess.call('python coffe.py input_files/hb0.txt -i 4 -o local >testhb.log', shell=True, executable='/bin/bash') 
# Run the tests
