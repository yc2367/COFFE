...
module  dsp_mac_8bit_stratix_altera_s10_native_fixed_point_dsp_1910_fqvgm5i  (
            accumulate,
            ax,
            ay,
            bx,
            ...
            defparam
					...
					fourteennm_mac_component.input_pipeline_clock="none",
					fourteennm_mac_component.second_pipeline_clock="none",
