...
module  dsp_mac_8bit_altera_a10_native_fixed_point_dsp_1910_3ymr7ea  (
            accumulate,
            ax,
            ay,
            bx,
            ...
            wire [15:0] sub_wire0;
            wire [15:0] resulta = sub_wire0[15:0];    
            ...
            twentynm_mac        twentynm_mac_component (
                                        ...
                                        .sub ());
            defparam
                    twentynm_mac_component.ax_width = 4,
                    twentynm_mac_component.ay_scan_in_width = 4,
                    twentynm_mac_component.bx_width = 4,
                    twentynm_mac_component.by_width = 4,
                    ...
                    twentynm_mac_component.accum_pipeline_clock = "2",
                    twentynm_mac_component.load_const_clock = "none",
                    twentynm_mac_component.load_const_pipeline_clock = "none",
                    twentynm_mac_component.input_pipeline_clock = "2",
                    twentynm_mac_component.output_clock = "1",
                    twentynm_mac_component.scan_out_width = 18,
                    twentynm_mac_component.result_a_width = 16;
